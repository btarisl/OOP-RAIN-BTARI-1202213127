...
public class Sampan extends TransportasiAir{
    ...
    public void berlabuh(){
        System.out.println("Transportasi Air Sampan diketahui sedang berlabuh di pantai tanpa jangkar");
    }

    public void berlabuh(int jangkar){
        System.out.println("Transportasi Air Sampan diketahui sedang berlabuh di pantai menggunakan "+jangkar+" jangkar");
    }
}
